			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="产品编号" prop="chanpinbianhao">
						<el-input class="list_inp" v-model="form.chanpinbianhao" placeholder="请输入产品编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="产品数量" prop="chanpinshuliang">
						<el-input class="list_inp" v-model.number="form.chanpinshuliang" placeholder="产品数量"
							 type="text" 							:readonly="!isAdd||disabledForm.chanpinshuliang?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="12">
					<el-form-item label="进货单价" prop="jinhuodanjia">
						<el-input class="list_inp" v-model.number="form.jinhuodanjia" placeholder="进货单价"
							 type="number" 							:readonly="!isAdd||disabledForm.jinhuodanjia?true:false" />
					</el-form-item>
				</el-col>
