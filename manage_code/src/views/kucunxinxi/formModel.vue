					...
					<el-col :span="12">
						<el-form-item label="产品名称" prop="chanpinmingcheng">
							<el-input class="list_inp" v-model="form.chanpinmingcheng" placeholder="产品名称"
                                type="text"
								:readonly="!isAdd||disabledForm.chanpinmingcheng?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="产品编号" prop="chanpinbianhao">
							<el-input class="list_inp" v-model="form.chanpinbianhao" :readonly="true" placeholder="产品编号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="产品数量" prop="chanpinshuliang">
							<el-input class="list_inp" v-model.number="form.chanpinshuliang" placeholder="产品数量"
                                type="text"
								:readonly="!isAdd||disabledForm.chanpinshuliang?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="进货单价" prop="jinhuodanjia">
							<el-input class="list_inp" v-model.number="form.jinhuodanjia" placeholder="进货单价"
                                type="number"
								:readonly="!isAdd||disabledForm.jinhuodanjia?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chanpinbianhao'){
					form.value.chanpinbianhao = row[x];
					disabledForm.value.chanpinbianhao = true;
					continue;
				}
				if(x=='chanpinshuliang'){
					form.value.chanpinshuliang = row[x];
					disabledForm.value.chanpinshuliang = true;
					continue;
				}
				if(x=='jinhuodanjia'){
					form.value.jinhuodanjia = row[x];
					disabledForm.value.jinhuodanjia = true;
					continue;
				}
